...
- (void)badgeInit
{
    ...
    self.badgeFont      = [UIFont systemFontOfSize:1];
    self.badgePadding   = 1;
    self.badgeMinSize   = 1;
    self.badgeOriginX   = self.customView.frame.size.width - self.badge.frame.size.width/2-1;
    self.badgeOriginY   = 2;
...
//    else
//    {
//        minWidth = expectedLabelSize.width;
//    }
    
    self.badge.frame = CGRectMake(self.badgeOriginX, self.badgeOriginY, 6, 6);
...
-(void) setBadgeValue:(NSString *)badgeValue
{
    ...
    if (!badgeValue || [badgeValue isEqualToString:@""] || ([badgeValue isEqualToString:@"0"] && self.shouldHideBadgeAtZero)) {
        ...
        self.badge                      = [[UILabel alloc] initWithFrame:CGRectMake(self.badgeOriginX, self.badgeOriginY, 1, 1)];
        self.badge.textColor            = self.badgeTextColor;
        self.badge.backgroundColor      = self.badgeBGColor;
        self.badge.font                 = self.badgeFont;
